...
require 'script files\inventory-function.js.php';
require 'script files\inventory-stock-checker-refresh.js.php';
?>
  ...
  <section class="content">
    ...
    <div class="web-content">
      <div class="menu">
        ...
        <div class="bttn">
          <?php require 'script files\inventory-product-id-gen.js.php'; ?>
      ...
      <div class="overview">
        ...
        <div class="item-table">
          ...
          <table>
            ...
            <tbody id="table-body">
              <?php require 'script files\inventory-refresh-data.js.php'; ?>
            </tbody>
          </table>
          </div>
        </div>
      ...
      <div class="form-popup" id="myForm">
        <form action="" class="form-container">
          ...
          <div class="form">
            ...
            <div class="inputfield">
              <?php require 'script files\inventory-data.js.php'; ?>
